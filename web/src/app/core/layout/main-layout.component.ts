...
export class MainLayoutComponent {
  ...
  readonly allNavItems: NavItem[] = [
    ...
    { label: 'Dashboard Execução', icon: 'play_circle', route: '/dashboard/execucao', roles: ['P01', 'P02'] },
    { label: 'Dashboard Qualidade', icon: 'verified', route: '/dashboard/qualidade', roles: ['P01', 'P07'] },
    ...
    { label: 'Recomendações', icon: 'recommend', route: '/recomendacoes', roles: ['P01', 'P02', 'P05', 'P06'] },
    { label: 'Auditorias', icon: 'search', route: '/auditorias', roles: ['P01', 'P02', 'P05', 'P06'] },
    { label: 'Universo Auditável', icon: 'account_tree', route: '/universo', roles: ['P01', 'P02'] },
    { label: 'Matriz Priorização', icon: 'priority_high', route: '/matriz-priorizacao', roles: ['P01', 'P02'] },
    ...
    { label: 'Achados', icon: 'warning', route: '/achados', roles: ['P01', 'P02', 'P05'] },
    { label: 'Relatórios', icon: 'picture_as_pdf', route: '/relatorios', roles: ['P01', 'P02', 'P03', 'P06'] },
    { label: 'Relatório Anual', icon: 'insights', route: '/relatorios-anuais', roles: ['P01', 'P04'] },
