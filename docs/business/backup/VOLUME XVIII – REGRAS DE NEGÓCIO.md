...
Este volume consolida todas as regras de negócio do CONFORMITAS, extraídas dos PRDs, especificações formais e volumes funcionais. Cada regra possui identificador único, descrição, criticidade, origem documental e entidades afetadas.
